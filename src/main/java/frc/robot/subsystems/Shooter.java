...
public class Shooter extends SubsystemBase {
  ...
  NetworkTableEntry entry_p = Shuffleboard.getTab("SmartPID")
  .add("kProportion",0)
  .withWidget(BuiltInWidgets.kNumberSlider)
  .withProperties(Map.of("min", 0, "max", 10))
  .getEntry();
  NetworkTableEntry entry_i = Shuffleboard.getTab("SmartPID")
  .add("kIntegral",0)
  .withWidget(BuiltInWidgets.kNumberSlider)
  .withProperties(Map.of("min", 0, "max", 10))
  .getEntry();;
  NetworkTableEntry entry_d = Shuffleboard.getTab("SmartPID")
  .add("kDerivitive",0)
  .withWidget(BuiltInWidgets.kNumberSlider)
  .withProperties(Map.of("min", 0, "max", 10))
  .getEntry();;
  NetworkTableEntry entry_f = Shuffleboard.getTab("SmartPID")
  .add("kFeedForward",0)
  .withWidget(BuiltInWidgets.kNumberSlider)
  .withProperties(Map.of("min", 0, "max", 10))
  .getEntry();;
  NetworkTableEntry entry_rpm = Shuffleboard.getTab("SmartPID")
  .add("kRotations",0)
  .withWidget(BuiltInWidgets.kNumberSlider)
  .withProperties(Map.of("min", 0, "max", 7200))
  .getEntry();
  ...
  public Shooter() {
    ...
    shooterWheel1Enc = shooterWheel1.getAlternateEncoder();
    shooterWheel2Enc = shooterWheel2.getAlternateEncoder();
  ...
  public void setShooterVelocity(double shooterVelocity){
    pidController1.setOutputRange(0, 7200);
    pidController2.setOutputRange(0, 7200);
